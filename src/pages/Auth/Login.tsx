...
import { Mail, Lock, LogIn, AlertCircle, Calendar, Clock, CheckCircle, Hourglass } from 'lucide-react'
    ...
    <div className="min-h-screen w-full relative bg-gradient-to-br from-blue-50 via-white to-blue-50">
      ...
      <div className="hidden lg:flex absolute inset-0 z-0 flex flex-col justify-center items-start px-8 lg:px-16 xl:px-24 text-gray-800">
        ...
        >
          ...
          >
            Kelola waktu Anda dengan lebih efisien menggunakan teknologi AI
          </motion.p>
          ...
          >
            {[
              { icon: Calendar, text: 'Jadwal Terorganisir dengan AI' },
              { icon: Clock, text: 'Reminder Otomatis via WhatsApp' },
              { icon: CheckCircle, text: 'Manajemen Waktu yang Efisien' },
            ].map((item, index) => {
      ...
      <div className="absolute inset-0 flex items-center justify-center lg:justify-end p-4 sm:p-6 md:p-8 lg:p-12 xl:p-16 z-10 overflow-y-auto min-h-screen">
        ...
        >
          ...
          <div className="text-center">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">Masuk</h2>
            <p className="mt-2 text-xs sm:text-sm text-gray-600">
              Belum punya akun?{' '}
              <Link to="/auth/register" className="font-medium text-primary-blue hover:text-blue-600">
                Daftar sekarang
              </Link>
            </p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-end">
              <Link
                ...
                className="text-sm font-medium text-primary-blue hover:text-blue-600"
              >
                Lupa password?
              </Link>
            </div>
